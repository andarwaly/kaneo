...
import { GhostIcon, Settings, Shield } from "lucide-react";
...
function RouteComponent() {
  ...
  const menuItems = [
    ...
    {
      title: t("settings:workspaceSilentMembers.title", {
        defaultValue: "Silent members",
      }),
      url: "/dashboard/settings/workspace/silent-members",
      icon: GhostIcon,
    },
  ];
